	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<form enctype="multipart/form-data" method="post" class="text-center">
			 <div class="col-md-12">
			 		...
			 		<label for="name">
					   Name: </label><input type="text" name="name" value="" placeholder="Full name" required>
					<br><br>
					...
					<label for="contact">
						Phone:</label> <input type="number" name="contact"  placeholder="contact no" required="required" pattern="[0-9]{10,11}" title="please enter only numbers between 10 to 11 for mobile no."/>
					<br><br>
 					
 					<label for="address">
						Address: </label><input type="text" name="address" value="" placeholder="address" required>
					<br><br>
					<label for="expertise">
						Category: </label>
					...
					<br><br>
					<label for="doctor">
						Doctor:</label> <select name="doctor" required>
										<option>-Select-</option>
					...
					<label for="date">
						Date: </label><input type="date" name="date" placeholder="choose ur date" >	
					<br><br>
					
					
					<button name="submit" type="submit" class="noselect yellow button2">Check</button> <br>
